...
const controlBase =
  "w-full rounded-md bg-background border border-border text-sm text-foreground transition-all duration-200 ease-out hover:border-primary/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:border-primary";
