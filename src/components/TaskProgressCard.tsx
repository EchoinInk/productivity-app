      ...
      <div className="flex items-center justify-between">
        <div className="relative w-24 h-24">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="text-xl drop-shadows 1xl font-bold leading-none">{percentage}%</span>
          </div>
        </div>

        <div className="text-right">
          <p className="text-[12px] drop-shadow-md opacity-95">Progress</p>
          <p className="text-lg drop-shadow lg font-semibold">Today Tasks</p>
          <p className="text-[11px] drop-shadow-md opacity-85 mt-1 italic tracking-[0.2px]">
